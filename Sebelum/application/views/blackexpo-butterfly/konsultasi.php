                    ...
                    <div class="blog-posts fbt-index-post-wrap">
                        ...
                        <form action="<?php echo base_url(); ?>konsultasi/reply" method="POST" onSubmit="return validasi(this)" id="form_komentar">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name='b' placeholder="Nama Anda" value='' class="form-control shadow-none radius-0" required/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Email *</label>
                                <div class="col-sm-10">
                                    <input type="text" name='c' placeholder="Alamat E-mail" id="email" value='' class="form-control shadow-none radius-0" required/>
                                </div>
                            </div>
